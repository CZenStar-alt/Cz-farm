...
Config.PotatoPrice = math.random(15, 25)
Config.CucumberPrice = math.random(15, 25)
Config.OnionPrice = math.random(15, 25)
Config.CabbagePrice = math.random(15, 25)
Config.LettucePrice = math.random(15, 25)
Config.CarrotPrice = math.random(15, 25)
Config.BeetPrice = math.random(15, 25)
Config.TurnipPrice = math.random(15, 25)
Config.MushroomsPrice = math.random(15, 25)
Config.MilkPrice = math.random(15, 15)
Config.OrangePrice = math.random(10, 15)
Config.PeachPrice = math.random(10, 15)
Config.PearPrice = math.random(10, 15)
Config.ApplePrice = math.random(10, 15)
Config.MangoPrice = math.random(10, 15)
Config.LemonPrice = math.random(10, 15)
